...
## ❗ READ FIRST
This project uses an **approximate** and **local** algoritm. It does not connect to any APIs. This means that it will not be 100% accurate all the time. I've cleaned up the phase calculation a little bit but the luminocity meter is still a little funky. 
## Usage:
